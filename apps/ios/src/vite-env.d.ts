...
interface Window {
  electron?: {
    ...
    wireguard: {
      ...
      install: (instanceId: string, configBody: string) => Promise<{ success: boolean; instanceId: string; configPath?: string }>;
      ...
      run: (instanceId: string, configBody: string) => Promise<{ success: boolean; message?: string; error?: string; instanceId: string }>;
      stop: (instanceId: string) => Promise<{ success: boolean; message?: string; error?: string; instanceId: string }>;
    };
  };
}
